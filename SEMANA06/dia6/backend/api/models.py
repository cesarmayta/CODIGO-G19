...
class Producto(models.Model):
    ...
    producto_descripcion = models.CharField(max_length=255,null=True)
...
class FacturaCab(models.Model):
    ...
    cliente = models.ForeignKey(Cliente, models.RESTRICT)
...
class FacturaDet(models.Model):
    ...
    producto = models.ForeignKey(Producto, models.RESTRICT)
    factura_cab = models.ForeignKey(FacturaCab, models.RESTRICT)
